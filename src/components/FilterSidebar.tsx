...
export default function FilterSidebar({
  ...
  minPrice, maxPrice, onMinPrice, onMaxPrice, onApplyPrice,
  brands, selectedBrands, onBrand,
}: Props) {
  return (
    <aside className="w-68 shrink-0 flex flex-col gap-5 bg-gray-100 px-8 py-6 border-right border-gray-200 min-h-[calc(100vh-64px)]">
      ...
      <div className="relative">
        ...
        <input
          ...
          placeholder="Search..."
          className="w-full pl-8 pr-3 py-1.5 border border-gray-300 rounded text-sm focus:outline-none focus:ring-2 focus:ring-blue-400"
        />
      </div>
